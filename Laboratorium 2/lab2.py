...
#zadanie 1
#narysować trójkąt z każdym wierzchołkiem innego koloru
...
#zadanie 2:
#należy napisać funkcję rysującą prostokąt w podanym miejscu
...
#zadanie 3
#należy wprowadzić losowość kolorów i deformacje w prostokącie
...
#należy narysować fraktal – prostokątny dywan Sierpińskiego
def zadanie_4(a, ss):
    zadanie_2_2(0, 0, a, a)
...
def render(time):
    ...
    #zadanie_3(0.0, 0.0, 60.0, 70.0, 5.0)
    zadanie_4(100, 1)
